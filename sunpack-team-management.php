...
Description: Manage comapany's team and generate a custom shortcode for your wordpress site.
Version: 0.1.1
Author: Gesiel Lucas
...
$loader = require SPK_PLUGIN_DIR. "/vendor/autoload.php";
$loader->addPsr4('LuaSpk\\', SPK_PLUGIN_DIR.'includes');
$loader->addPsr4('LuaSpk\\Classes\\', SPK_PLUGIN_DIR.'includes/classes');
// echo "<pre>";
// print_r($loader);

use LuaSpk\Classes\SPKTM_Activation;
use LuaSpk\Classes\SPKTM_Bootstrap;

add_action('plugins_loaded', function(){
    SPKTM_Bootstrap::instance();
});

function activate_sunpack_team_management() {
    SPKTM_Activation::activate();
}
